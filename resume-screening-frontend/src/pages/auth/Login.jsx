  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden bg-surface-950">
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        {/* Card */}
        <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10
                        shadow-2xl p-8">
          {/* Error Banner */}
          {error && (
          ...
          {googleError && (
            <div className="mb-5 flex items-start gap-3 bg-red-500/10 border border-red-500/20
              ...
              <span>{errorMessages[googleError] ?? "Login failed. Please try again."}</span>
            </div>
          )}

          {/* Reset success */}
          {resetSuccess === "success" && (
            <div className="mb-5 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400
