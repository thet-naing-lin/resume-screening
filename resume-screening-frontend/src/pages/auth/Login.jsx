...
export default function Login() {
  ...
  return (
    <div className="min-h-screen relative flex bg-surface-950 overflow-hidden">
      {/* ── Left branding panel (tablet+) ── */}
      <div className="hidden md:flex md:w-1/2 lg:w-[45%] relative flex-col items-center justify-center p-10 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-md animate-slide-up">
          <div
            className="inline-flex items-center justify-center w-20 h-20
                          bg-gradient-to-br from-brand-500 to-brand-600 rounded-3xl mb-6
          ...
          <div className="mt-10 space-y-4 text-left">
            {[
              { icon: "🎯", text: "Automated candidate scoring with TF-IDF & semantic analysis" },
              { icon: "📊", text: "Real-time dashboards and ranked candidate views" },
              { icon: "🔒", text: "Role-based access control with audit logging" },
            ].map((feature) => (
              <div
                key={feature.text}
                className="flex items-start gap-3 bg-white/5 backdrop-blur-sm rounded-2xl px-5 py-3.5 border border-white/5"
              >
      ...
      {/* ── Right form panel ── */}
      <div className="w-full md:w-1/2 lg:w-[55%] relative flex items-center justify-center p-4 overflow-y-auto">
        {/* Background for mobile (full) and subtle gradient for tablet split */}
