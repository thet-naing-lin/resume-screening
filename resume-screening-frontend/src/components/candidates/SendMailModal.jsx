    ...
    <div className="fixed inset-0 bg-surface-950/60 backdrop-blur-sm flex items-center justify-center z-50 p-4"
      ...
      <div className="bg-white rounded-3xl shadow-modal w-full max-w-2xl flex flex-col max-h-[90vh] animate-scale-in
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-800">
          <div>
            <h2 className="font-bold text-surface-900 text-lg dark:text-surface-50">Send Email</h2>
            <p className="text-sm text-surface-400">
              To: <span className="font-medium text-surface-600 dark:text-surface-300">{candidateName}</span>
              {" "}
        ...
        <div className="overflow-y-auto flex-1 px-6 py-5 space-y-5">
          ...
          <div className="flex gap-1.5 p-1 bg-surface-100 rounded-2xl dark:bg-surface-800">
            <button
          ...
          {fetching ? (
            <div className="space-y-3 animate-pulse">
              <div className="h-10 bg-surface-100 rounded-2xl dark:bg-surface-800" />
              <div className="h-48 bg-surface-100 rounded-2xl dark:bg-surface-800" />
            </div>
          ) : (
            <>
              {/* To Email */}
              ...
              {/* Body */}
              <div>
                <label className="block text-sm font-medium text-surface-700 mb-1.5 dark:text-surface-300">Message Body</label>
                <textarea
                  rows={12}
                  value={body}
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-surface-100 flex justify-end gap-2 dark:border-surface-800">
